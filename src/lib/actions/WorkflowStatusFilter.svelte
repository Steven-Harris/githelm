...
<div class="flex flex-wrap items-center gap-2">
  ...
  <div class="flex flex-wrap gap-1">
    ...
    <button
      type="button"
      class="px-2 py-0.5 rounded-full text-xs border transition-opacity flex items-center gap-1 bg-[#21262d] hover:bg-[#30363d] text-[#c9d1d9] border-[#30363d]"
      onclick={resetWorkflowStatusFilters}
