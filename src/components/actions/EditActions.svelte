<script lang="ts">
  ...
  import EditActionForm from "./EditActionForm.svelte";

  let { configs } = $props();
  onMount(() => {
    const ACTIONS_CONFIGS = document.getElementById("actions-configs")!;
    Sortable.create(ACTIONS_CONFIGS, {
      animation: 150,
