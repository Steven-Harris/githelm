...
<div class="flex items-center space-x-4">
  <label for="commit-selector" class="text-sm font-medium text-[#9dabc4]">View changes:</label>
  <div class="relative w-64">
    <select
      ...
      class="block w-full appearance-none rounded-md border border-[#243044] bg-[#0a0e17] px-3 py-2 pr-9 text-sm text-[#e9eefb] shadow-sm hover:border-[#3d444d] focus:outline-none focus:ring-2 focus:ring-[#79b8ff] focus:border-[#79b8ff]"
    >
    ...
    <svg
      class="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#9dabc4]"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  {#if selectedCommit}
    ...
    {#if commit}
      <div class="flex items-center text-sm text-[#9dabc4]">
        <span>by</span>
        {#if commit.author}
